...
class ProjectDetailScreen extends StatelessWidget {
  ...
  // Función para convertir códigos de región a nombres bonitos
  ...
  void _showDeleteJobDialog(BuildContext context, String projectId,
      int jobIndex, String jobDescription, ProjectProvider provider) {
    showDialog(
      context: context,
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content:
              Text('¿Estás seguro de que deseas eliminar "$jobDescription"?'),
          actions: [
            TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    final grandTotal =
        project.jobs.fold(0.0, (sum, job) => sum + job.totalCost);
          ...
          IconButton(
            ...
            onPressed: () async {
              await Printing.sharePdf(
                  bytes: await generatePdf(project),
                  filename: '${project.projectName}_presupuesto.pdf');
            },
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Región: ${_getRegionDisplayName(project.region)}',
            ...
            Expanded(
              child: project.jobs.isEmpty
                  ? const Center(
                      child: Text('No hay partidas añadidas a este proyecto.'))
                  : ListView.builder(
