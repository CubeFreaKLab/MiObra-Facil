...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _showDeleteDialog(BuildContext context, String projectId,
      String projectName, ProjectProvider provider) {
    showDialog(
      context: context,
            ...
            child: Padding(
              ...
              child: Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) {
                  // Si no existe la imagen, mostrar mensaje simple
                  return const Text(
                    'No hay proyectos',
                    style: TextStyle(
                      fontSize: 18,
                  ...
                  trailing: PopupMenuButton<String>(
                    onSelected: (value) {
                      if (value == 'edit') {
                        ...
                        _showDeleteDialog(context, project.id,
                            project.projectName, projectProvider);
                      }
                    },
                    itemBuilder: (BuildContext context) => [
                      const PopupMenuItem<String>(
